    ...
    <script type="text/javascript">
      ...
      google.charts.setOnLoadCallback(drawChartDeposits);
            ...
            function drawChartDeposits() {
              ...
              var chart = new google.visualization.PieChart(document.getElementById('Deposits_chart_div'));
              chart.draw(data, options);
              }
    </script>

<div id="Spending_chart_div" class="d-flex mr-auto" display="block"></div>
<div id="Deposits_chart_div" class="d-flex ml-auto" display="block"></div>
